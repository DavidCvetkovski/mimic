...
public enum Prose {
    ...
    /// handed that alone repeats it straight back instead of writing one.
    ...
    public static func asked(_ instruction: String) -> String {
        ...
        let alreadyAnInstruction = verbs.contains { trimmed.lowercased().hasPrefix($0) }
        if alreadyAnInstruction { return trimmed }
